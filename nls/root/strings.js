...
define({
    ...
    BUTTON_RESET_HARD:                  "Reset to this commit and discard the current changes.",
    BUTTON_RESET_SOFT:                  "Reset to this commit but retain the current changes for commit.",
    BUTTON_RESET_MIXED:                 "Reset to this commit but not mark current changes for commit.",
    CHANGELOG:                          "Changelog",
