...
define({
    ...
    BUTTON_RESET:                       "Reset\u2026",
    BUTTON_RESET_HARD:                  "Reset hard",
    BUTTON_RESET_MIXED:                 "Reset mixed",
    BUTTON_RESET_SOFT:                  "Reset soft",
    BUTTON_SAVE:                        "Save",
    ...
    TOOLTIP_CHECKOUT:                   "Checkout a specific commit. Note that you'll probably run into a detached mode",
    ...
    TOOLTIP_RESET:                      "Reset to a the selected commit. Use with caution!",
