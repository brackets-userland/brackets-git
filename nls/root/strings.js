define({
    ...
    ADVANCED_FEATURES_WARNING:          "These features are not recommended for basic Git users as they may cause you to lose code that has already been committed if used improperly. Use with caution.",
